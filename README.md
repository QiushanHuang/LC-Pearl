...
- Academic manuals in Markdown and HTML under `MANUAL.md` and `docs/`.
...
- `docs/LC_Pearl_v2.1_Academic_User_Manual.md`

Historical process notes are kept separately in `docs/` and are not the current algorithm reference.
...
- `configs/` 中的快速配置文件。
- `MANUAL.md` 和 `docs/` 中的 Markdown/HTML 学术手册。
